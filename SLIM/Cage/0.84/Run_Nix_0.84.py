...
# Get args from arg parser:
    ...
    parser.add_argument('-src', '--source', default="Discrete_Homing_Nix_0.84.slim", type=str,
    help=r"SLiM file to be run.")
    parser.add_argument('-outfile', '--output_file', default="Starting_0.84.xlsx", type=str)
